...
carros <- read_csv("D:\\Data_Science\\Cursos\\DSA\\Formacao_Cientista_de_Dados\\Big_Data_Analytics_com_R_e_Microsoft_Azure_Machine_Learning\\Modulo7\\carros-usados.csv")
...
hist(carros$kilometragem, main = "Histograma para a Km de Carros Usados", xlab = "Kilometragem")
hist(carros$kilometragem, main = "Histograma para a Km de Carros Usados", breaks = 5, xlab = "Kilometragem")
